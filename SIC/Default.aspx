...
<head id="Head1" runat="server">
    <title>Encryption/Decryption String</title>
        ...
        <header>
            <div class="appheader">
                ...
                <div id="messageCol" style="display: inline; text-align: right; width: 50%; float: left" class="visible-md visible-lg">
                    ...
                    <br />
                    <br />
                    <div style=" display: none; font-size: smaller; text-wrap: avoid">
    ...
    $(document).ready(function () {
        ...
        $("#LabelTrain").click(function () {
            if ($("#hfUserID").val() == "mif") {
                ...
                pageid = $("#hfPageID").val();
                userid = $("#hfUserID").val();
                openEditPageA('450','800', 'Loading.aspx?pID=Encryption', 'Encription String');
            }
        });
    });
